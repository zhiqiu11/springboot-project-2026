      ...
      <el-table :data="data.tableData" stripe>
        <el-table-column prop="goodsImg" label="商品图片">
          <template #default="scope">
            <el-image style="width: 50px; height: 50px; display: block; border-radius: 5px" :src="scope.row.img" :preview-src-list="[scope.row.img]" preview-teleported></el-image>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="userId" label="评价用户"></el-table-column>
