<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 30px; text-align: center; margin-bottom: 30px; color: green">欢 迎 注 册</div>
      <el-form :model="data.form"  ref="formRef" :rules="data.rules">
        ...
        <el-form-item>
          <el-button size="large" style="width: 100%;background-color: green; color: white" @click="register">注 册</el-button>
        </el-form-item>
      </el-form>
